...
mixin _$Deck {
  ...
  String get colorThemeId => throw _privateConstructorUsedError;
...
abstract class $DeckCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String colorThemeId, DateTime createdAt});
}
      ...
      _value.copyWith(
            ...
            name: null == name
                ...
                : name // ignore: cast_nullable_to_non_nullable
                      as String,
            colorThemeId: null == colorThemeId
                ? _value.colorThemeId
                : colorThemeId // ignore: cast_nullable_to_non_nullable
                      as String,
...
class _$DeckImpl implements _Deck {
  ...
  @override
  String toString() {
    return 'Deck(id: $id, name: $name, colorThemeId: $colorThemeId, createdAt: $createdAt)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.colorThemeId, colorThemeId) ||
                other.colorThemeId == colorThemeId) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, colorThemeId, createdAt);
...
abstract class _Deck implements Deck {
  const factory _Deck({
    ...
    required final String colorThemeId,
