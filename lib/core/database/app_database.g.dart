...
class $DecksTable extends Decks with TableInfo<$DecksTable, DeckRow> {
  ...
  @override
  late final GeneratedColumn<String> colorThemeId = GeneratedColumn<String>(
    'color_theme_id',
    aliasedName,
    false,
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('pastelOcean'),
  );
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, colorThemeId, createdAt];
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('color_theme_id')) {
      context.handle(
        _colorThemeIdMeta,
        colorThemeId.isAcceptableOrUnknown(
          data['color_theme_id']!,
          _colorThemeIdMeta,
        ),
      );
  ...
  DeckRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DeckRow(
      ...
      colorThemeId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}color_theme_id'],
      )!,
...
class DeckRow extends DataClass implements Insertable<DeckRow> {
  ...
  factory DeckRow.fromJson(
    ...
    return DeckRow(
      ...
      colorThemeId: serializer.fromJson<String>(json['colorThemeId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'colorThemeId': serializer.toJson<String>(colorThemeId),
  ...
  DeckRow copyWithCompanion(DecksCompanion data) {
    return DeckRow(
      ...
      colorThemeId: data.colorThemeId.present
          ? data.colorThemeId.value
          : this.colorThemeId,
  ...
  String toString() {
    return (StringBuffer('DeckRow(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('colorThemeId: $colorThemeId, ')
  ...
  @override
  int get hashCode => Object.hash(id, name, colorThemeId, createdAt);
  @override
  bool operator ==(Object other) =>
      ...
      (other is DeckRow &&
          ...
          other.colorThemeId == this.colorThemeId &&
...
class DecksCompanion extends UpdateCompanion<DeckRow> {
  ...
  const DecksCompanion({
    ...
    this.colorThemeId = const Value.absent(),
  ...
  static Insertable<DeckRow> custom({
    ...
    return RawValuesInsertable({
      ...
      if (colorThemeId != null) 'color_theme_id': colorThemeId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (colorThemeId.present) {
      map['color_theme_id'] = Variable<String>(colorThemeId.value);
    }
...
class $$DecksTableFilterComposer extends Composer<_$AppDatabase, $DecksTable> {
  ...
  ColumnFilters<String> get colorThemeId => $composableBuilder(
    column: $table.colorThemeId,
    builder: (column) => ColumnFilters(column),
  );
...
class $$DecksTableOrderingComposer
  ...
  ColumnOrderings<String> get colorThemeId => $composableBuilder(
    column: $table.colorThemeId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$DecksTableAnnotationComposer
  ...
  GeneratedColumn<String> get colorThemeId => $composableBuilder(
    column: $table.colorThemeId,
